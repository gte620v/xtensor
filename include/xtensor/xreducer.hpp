...
#define DEFAULT_STRATEGY_REDUCERS evaluation_strategy::lazy
    ...
    namespace detail
    {
        ...
        template <std::size_t X, std::size_t I1, std::size_t... I>
        struct in_impl<X, I1, I...>
        {
            constexpr static bool value = I1 == X || in_impl<X, I...>::value;
        };

        template <std::size_t X, std::size_t I1>
        struct in_impl<X, I1>
        {
            constexpr static bool value = I1 == X;
        };

        template <std::size_t X, std::size_t... I>
        struct in
        {
            constexpr static bool value = in_impl<X, I...>::value;
        };
